    ...
    about: {
        ...
        strengths: [
            ...
            },
            {
                ...
                text: "様々な技術スタックを用いた個人開発を継続し、フレームワークごとの特性を理解しながら、新しい技術や開発手法を学び、スキルアップに取り組んでいます。",
            },
        ],
        skills: [
            {
                header: "Frontend",
                text: "React / Next.js / TypeScript / Tailwind CSS / Vue.js / JavaScript",
            },
            {
                header: "Design",
                text: "Figma",
